...
public class CurrencyData
{
    ...
    public void InitializeDefaultUpgrades()
    {
        ...
        upgrades["BaseProduction"] = new UpgradeData("Base Production", 1, 1, 25, 
            ...
            new double[] { 1.08, 1.1, 1.125, 1.15, 1.2, 2, 10 }, // Multipliers: +10%, +15%, etc.
        ...
        upgrades["nextLetterMulti"] = new UpgradeData(
            ...
            new int[] { 5, 10, 20, 25, 50}, new double[] {3.5, 5, 7.5, 10, 20}, true, 0.5);
        upgrades["nextLetterExponent"] = new UpgradeData(
            "Next Letter Exponent", 1, 0, 500000000000000000, 
            new int[] { 5, 10, 20, 25, 50}, new double[] {5, 7.5, 10, 20, 50}, true, 0.1);
    }
