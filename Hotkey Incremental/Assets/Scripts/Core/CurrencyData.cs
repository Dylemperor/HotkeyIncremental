...
public class CurrencyData
{
    ...
    public void InitializeDefaultUpgrades()
    {
        ...
        upgrades["BaseProduction"] = new UpgradeData("Base Production", 1, 1, 25, 
            new int[] { 10, 25, 50, 100, 250, 500, 1000 }, // Phase thresholds: level 5, level 25, etc.
        ...
        double[] exponentMultipliers = isLetterA
            ? new double[] { 2.5, 2.75, 3, 3.5, 5, 10, 75 } // Original for A
            : new double[] { 2.9, 3.2, 3.6, 4.2, 6, 12, 100 }; // Harsher for B-Z
        
        upgrades["Exponent"] = new UpgradeData(
            "Exponent", 1, 1, 10000, 
            new int[] { 10, 25, 50, 100, 500, 1000 }, 
        ...
        upgrades["nextLetterMulti"] = new UpgradeData(
            ...
            new int[] { 5, 10, 20, 25, 50}, nextMultiMultipliers, true, 1);
